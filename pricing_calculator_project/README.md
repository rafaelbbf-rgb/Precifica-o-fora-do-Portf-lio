...
6. [Relatório do vendedor (PDF)](#relatório-do-vendedor-pdf)
7. [Comprovação de Custo (Memória de Cálculo)](#comprovação-de-custo-memória-de-cálculo)
8. [Regras de cálculo](#regras-de-cálculo)
9. [Como trocar o logo](#como-trocar-o-logo)
10. [Como alterar a paleta de cores](#como-alterar-a-paleta-de-cores)
11. [Documentos de identidade visual](#documentos-de-identidade-visual)
12. [Limitações](#limitações)
13. [Instruções para Windows](#instruções-para-windows)
...
> repositório. O campo de coeficiente também é editável na própria tela.
