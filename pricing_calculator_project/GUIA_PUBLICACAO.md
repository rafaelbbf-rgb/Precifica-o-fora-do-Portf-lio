...
## Parte 3 — Configurar credenciais e coeficiente (Secrets)
...
2. Cole e ajuste:
   ...
   (Use os valores reais que você definiu — eles ficam só aqui, nunca no código.)

3. Clique em **Save**. O app reinicia e passa a usar o login e o coeficiente.

> Enquanto as credenciais não forem configuradas, o app mostra um aviso de
